...
namespace thcp.Migrations
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DepartamentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DepartamentName = table.Column<string>(type: "nvarchar(70)", maxLength: 70, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "PerceptionTypes",
                columns: table => new
                {
                    PerceptionTypeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Description = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PerceptionTypes", x => x.PerceptionTypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Position_Departaments_DepartamentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Deductions_Measures_MeasureId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PerceptionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Description = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    Value = table.Column<decimal>(type: "decimal(12,2)", nullable: false),
                    PerceptionTypeId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Perceptions_Measures_MeasureId",
                        column: x => x.MeasureId,
                        principalTable: "Measures",
                        principalColumn: "MeasureId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Perceptions_PerceptionTypes_PerceptionTypeId",
                        column: x => x.PerceptionTypeId,
                        principalTable: "PerceptionTypes",
                        principalColumn: "PerceptionTypeId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Indentity = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Perceptions_MeasureId",
                table: "Perceptions",
                column: "MeasureId");

            migrationBuilder.CreateIndex(
                name: "IX_Perceptions_PerceptionTypeId",
                table: "Perceptions",
                column: "PerceptionTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Position_DepartamentId",
                table: "Position",
